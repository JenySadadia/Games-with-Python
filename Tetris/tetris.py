...
class Board():
    ...
    def can_move(self, x, y):
        ...
        #YOUR CODE HERE
        if Tetris.BOARD_WIDTH-1>=x>=0 and Tetris.BOARD_HEIGHT-1>=y>=0:
    ...
    def game_over(self):
        ...
        #YOUR CODE HERE
        msg=Text(Point(150,150),"Game Over !!!")
        msg.setSize(30)
...
class Tetris():
    ...
    def create_new_shape(self):
        ...
        if a==0:
            i=Tetris.SHAPES[0](Point(int(self.BOARD_WIDTH/2),0))
            return i
        elif a==1:
            i=Tetris.SHAPES[1](Point(int(self.BOARD_WIDTH/2),0))
            return i
        elif a==2:
            i=Tetris.SHAPES[2](Point(int(self.BOARD_WIDTH/2),0))
            return i
        elif a==3:
            i=Tetris.SHAPES[3](Point(int(self.BOARD_WIDTH/2),0))
            return i
        elif a==4:
            i=Tetris.SHAPES[4](Point(int(self.BOARD_WIDTH/2),0))
            return i
        elif a==5:
            i=Tetris.SHAPES[5](Point(int(self.BOARD_WIDTH/2),0))
            return i
        elif a==6:
            i=Tetris.SHAPES[6](Point(int(self.BOARD_WIDTH/2),0))
            return i
    ...
    def do_move(self, direction):
        ...
        if self.current_shape.can_move(self.board,Tetris.DIRECTION[direction][0],Tetris.DIRECTION[direction][1]):
            ...
            self.current_shape=Tetris.create_new_shape(self)
